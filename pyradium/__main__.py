...
def main():
	...
	def genparser(parser):
		...
		parser.add_argument("-m", "--mode", choices = [ "print", "vim", "fulljson" ], default = "print", help = "Mode in which spellchecking is performed. Can be one of %(choices)s, defaults to %(default)s.")
